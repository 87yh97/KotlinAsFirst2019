...
class Tests {
    ...
    fun firstDuplicateIndex() {
        ...
        assertEquals(-1, firstDuplicateIndex("  a b"))
        assertEquals(-1, firstDuplicateIndex("  a a"))
    ...
    fun mostExpensive() {
        ...
        assertEquals("", mostExpensive("        "))
        assertEquals("", mostExpensive("  Вино 255.0"))
        assertEquals("", mostExpensive("Вино 255.0   "))
        assertEquals("", mostExpensive("Вино   255.0"))
        assertEquals("", mostExpensive("Вино ab"))
        assertEquals("", mostExpensive("Вино 12,1"))
    ...
    fun fromRoman() {
        ...
        assertEquals(-1, fromRoman("0"))
        assertEquals(-1, fromRoman(""))
        //assertEquals(-1, fromRoman("1"))
    }
    ...
    fun computeDeviceCells() {
        ...
        assertEquals(listOf(2), computeDeviceCells(1, "+[+-]", 3420))
        assertEquals(listOf(124, 1), computeDeviceCells(2, "[+][+++++]+[<+>]", 500))
        assertThrows(IllegalArgumentException::class.java) { computeDeviceCells(10, "===", 3) }
        assertThrows(IllegalArgumentException::class.java) { computeDeviceCells(10, "+>+>[+>", 3) }
        assertThrows(IllegalStateException::class.java) { computeDeviceCells(20, ">>>>>>>>>>>>>", 12) }
        assertEquals(listOf(0), computeDeviceCells(1, "[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-+- -> <]<<-]++< <>--+ -><+<>]-< <]- --<-+-<>-+<+-><+++[]]-->+<+---- --<<+<-- +++<+<----++>->]]++<-+<<-<--<[<+++-+ >]---+-+-<<++[<-<<-+-<+--[+>><+--+<+-- ---] --->+]]-[] -<<<+--<+] <---- <]-< ]]-]-<-[ <-+-<<<< ++<+-<- +-+<]- -- ++] -><+<<-+-<-<<>+<] ----[-+]>+<<-<< ++>--<+<> ->]-+--><<- -><++ < <-<----+ ----[->>-+-<+<<<++-<>-+<+-+-<-<-]--<  <-++<[+-+<-<--<--+<<<-+]>[<+]---<+]-<-><>]+<<-<<-+>+[--+<-<---+-[+[ +-+[<+- ]>< +-< ++++]<<++-<+-+-<+-[]-< --<++----+++ -+--+-++<----[]+->+-]<>-+<--+-+>---]+>-++-+--[------+[++[--+<<-<<-- -<-<+---<+-+++>-+--+>]-<<->-<>-+]<<<]<-+<<++---]>-<<>>++]+ -<<<-+-[---<-]++++>]]+  <--<- ]--<<+[<--<-++<+<<>+---<<>--+<-<-- >]+>-<++-+--<- ++-<-]>-<<-<+<--]+<<-[>--+<--<]-+-+->[[<-<+ [+-<-+<+--]+->+-[-><]<----+<--<]<[+-><[ <-]<--+--<<-+-[+[++-+---]-+><><->+>><<<-+]-<-- <- <--+ -] + ---+++<- +>-----]>--  <+<-]-+---+<+ <<-<>--]+]-<--+]--  +>+<+-<>-<+->]] --[<+<>- --<]<<>++<<+<<+-<<-<++[]<-[+<+-<-+++<+<+---]+][-[]]<<<+<]->++----+<+--[ <- <+---+<-<+-+<-<+ <[+-+-+-[->+<+-+-+<]--+- +-<++ - -->+---+>+-+<<]-<<[---[->+-<-+--<-+-+-<- ->+-+  <---+<-<>><-+<--<<++-- < +]-+ +--<><]+]<-<--<--++-><+[+<- +-<+-<[ - -<]---+-<--+-<<<---<[+--<-+-+<-+ -+-<-[-]]++-+--[++>[-[+<<-+-+<+--[++><<--[-<<--  >+-[]-<-[---<+<>[<]+<-[ +[ <---<-<-++[--->+<>+---+<-<-><<]--<--+<+-<-+-+[[]+<-[<-<- <<]<<]-[-----[[>[-+<>+---<><<-<>[---->>-++]-<--<<<-<+<<---+-<+><]<>+<< ><++>]< +--><]+<+ <+++<+-]<+[[ ->  [+<]+--+<-- +>+-]++-+-]+--+-<-------[+-<< ---< <<-<<<[> <<++-+-+<<>[[--]-<+>+<+-><++<<-->--<->--<>-+<+][--[]>- -+---+-]-+-]- ++-+]-<+--]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]", 7588))
        //assertEquals(listOf(0), computeDeviceCells(1, "[[[+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<-[><+>>-[+<+-]<+[-+-+]+<-+[[-><---- >[]<->----< >< [+- ++- -] [<++<-<+-><<---<+-++>>><--<<+]-+-<-]]]<<+-+]+[++--+----+<++>+---<->+-+--+[-<-<-  ]---+- --][-<< ++]+-+-++-]<<[-++->-<>[<-+-+<-]>+]--+<<- --+--+<+-+-<]<-<[<[<--- ++-----<< ++--[<><--><<]--+++- -++]+< - -+++<<+><-++ -< ] <>>-<- ---+-++<<+>[-+[+[+--]>-[ ->>]----<<>---+-<---<<<-<+ - <<  +--[+<-< -<-<->-+<<<+>++[>]-+-<-<>+-<+----[--+<><+-<-+ --]-++][--<<+>-] ]+[[-<-<>-<<-<<--  +---++][++-[---<<-[[> >-+--]>>-]-]-<+ >+<[->[-[<+<--+<+ ---[>+--<<[---+--+[-+->-<--[-<<+-> ->[+-+-++---[[---]<]-[]+[<<-<+<<<]-<[>-+[+--+-<+><-][+[---><]+-[>--< -+]- -+<-+ -+>-[+-- -<+- + +<+>-[ [>--->+--<>++<<++-<-+<+<+ --+] <<+<<>-[+--++--<+---]--+<<]<<<++<-+-+--<++->++--+<[< -+-+<+-><-+<- <-[>[]  <<<--+-<+-<->>- -+-<+<-><-++< [>----[-- --<]<+++<<-----++[----<+-<+<+-<]-- <---->[<+<]<<><>-----+---[]-<<<-<- +-<>[++-<<-+<--+-<<>-- <][[+><[-----<+ --]-++>+--> -+ --- -+[[--< <+ -<--+<<<---]>----+++--+->+<<+><<]-]+-<+-<<+<<+ --++<[<<<<-->+<<< -+-<-++-<-+]-+]---]<--+<+->--<<[>---<-<<- ++>--+---<-]- -<->-[--+--<<--<-+-->]++<<-[--++<[-<-+-+<+[>>-++-++--+++>]-++]-<[+<]-- >-<-+ <-- ++-- ]] -+><<<<----<]------>-<-<>++-+--+<<--<--<-+- >-+-]-<+]<+--]---- +>][-<-+[]-+>+--+[ +---+[- --+-+<>+-<<[<-<<[++->++>[++-----[><-]-- -+--<+>-[[[ ++++<-]+->-+<+<+-<-->-<<-[-+-]-+>--]]---<---++<-[>+->++[-[-<+---<<+-+-[+-+ +-><<-<+-+--+[+-+[-+><]+--+>+>+--<-<-++<+> --<-+]-]-<+->+[-+-<-<---<+<[<+--<]>>-<>--- --+<-+->-<>-]- <[<<+--]+>-+]---]]<-<+---]<+->-->+<><<[[]+-->]--<--  <<-<+<][+-<--<<-] +--]<++[<--<<<]-->]<]+>-[++->+-+++[[]- +->-[<-<--<------+<<-- ++]<<+<-<+<+]--+->]<+-<+---<+[ -<+--->+]]]]]]]]]]]]", 7954))
    }
}